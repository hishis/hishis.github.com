...
const app = new Vue({
    ...
    created () {
        ...
        this.FG.script.updateURL = this.FG.data.GitHub ? 'https://cdn.jsdelivr.net/gh/hishis/forum-grandmaster-for-discuz/main.user.js?r='.concat(Math.random()) : 'https://greasyfork.org/scripts/400250/code/main.user.js';
